      ...
      {nearQualification.length > 0 ? (
        ...
        >
          ...
          <p style={{ margin: `0 0 ${spacing[3]}`, fontSize: typography.scale.xs, color: colors.textMuted, lineHeight: 1.5 }}>
            Below the setup score floor but showing signal alignment — not actionable entries.
          </p>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "baseline", gap: spacing[2] }}>
        ...
        <span style={{ fontSize: typography.scale.sm, color: "#f59e0b" }}>🟠 {align}</span>
      </div>
      <Link
  ...
  return (
    ...
    >
      <div>
        ...
        <span style={{ marginLeft: spacing[2], fontSize: typography.scale.sm, color: "#f59e0b" }}>
          {row.label}
        </span>
      </div>
      <Link
