...
export function DashboardRedesign({ marketOverview, pdtStatus, scannerOverview, earningsEvents }: DashboardRedesignProps) {
  ...
  const morningVisible = isMorningBriefingWindowNow() && !!scannerOverview.morningBrief;
  ...
  return (
    <section style={{ display: "grid", gap: spacing[4] }}>
      ...
      {morningVisible && scannerOverview.morningBrief ? (
        <article
          style={{
            border: `1px solid ${colors.border}`,
            borderRadius: borderRadius.xl,
        ...
        >
          ...
          >
            Morning brief · {scannerOverview.morningBrief.conditions.label} conditions
          </button>
          {briefOpen ? (
            <div style={{ marginTop: spacing[3], display: "grid", gap: spacing[4] }}>
              ...
              {(() => {
                const mb = scannerOverview.morningBrief;
                  ...
                  <>
                    ...
                    <section>
                      ...
                      {earnList.length > 0 ? (
                        <ul style={{ margin: spacing[2] + " 0 0", paddingLeft: 18, display: "grid", gap: spacing[1] }}>
                          {earnList.map((e) => (
                            <li key={e.symbol} style={{ fontSize: typography.scale.xs, color: colors.text, fontFamily: typography.fontFamilyMono }}>
