...
describe("MaturationFrequencyCallout", () => {
  test("renders cadence bullets and optional display bands", () => {
    ...
    expect(screen.getByTestId("maturation-frequency-callout")).toHaveTextContent(/Dashboard/i);
    expect(screen.getByTestId("maturation-frequency-callout")).toHaveTextContent(/Watchlists/i);
