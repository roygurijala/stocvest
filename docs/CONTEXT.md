...
**Test baseline (regression gate — must match §13):** Backend `pytest tests/ -q` → **470 passed**, **3 skipped**. Frontend `npm run test` → **50 passed** (18 test files). **`npm run build`** last verified: success.
