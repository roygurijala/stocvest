...
**Test baseline (regression gate — must match §13):** Backend `pytest tests/ -q` → **906 passed**, **3 skipped**. Frontend `npm run test` → **161 passed** (30 test files). **`npm run build`** last verified: success.
