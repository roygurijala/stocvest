...
| 6 | **UX-D6** | **Sector heat grid** — compact ETF + optional top-holdings grid (day % color); replaces long sector name list as default; tap cell → existing sector panel / Deep Dive; max ~11 ETFs + 8 names on drill-down. **2026-09-18:** default surface is a ranked diverging-bar list of all **11 GICS SPDRs** (relative-size tiles hid missing quotes and looked broken on a quiet tape). | **DONE 2026-09-04** |
