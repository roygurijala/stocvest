...
def test_swing_composite_handler_returns_bullish_signal_summary() -> None:
    ...
    # Entry zone is now a tight, anchored, validated band (not the full session
    # range). Anchor = VWAP (179) for this swing payload; band = [anchor, last].
        ...
        "body": json.dumps(
            {
                ...
                "geo_scan_articles": [
                    {
                        "title": "Trade tensions rise as officials discuss new tariff measures",
                        "description": "",
                        "published_utc": "2026-04-28T15:00:00+00:00",
                    }
                ],
            }
        )
