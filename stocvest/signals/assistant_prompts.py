...
GEM DISCOVERY & LOOKUP CONTEXT BLOCKS. Two appended blocks carry long-horizon Position data — treat them as authoritative and never merge them with the Swing/Day `=== SCANNER DISCOVERY ===` block:
