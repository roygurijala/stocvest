...
class DynamoDBUserAlertStore:
    ...
    def get_preferences(self, user_id: str) -> AlertPreferences:
        ...
        return AlertPreferences(
            ...
            on_signal_fired=bool(it.get("onSignalFired", False)),
            on_confluence_alert=bool(it.get("onConfluenceAlert", False)),
            ...
            on_watchlist_maturation=bool(it.get("onWatchlistMaturation", False)),
            on_execution_actionable=bool(it.get("onExecutionActionable", True)),
            on_tracked_plan_thesis=bool(it.get("onTrackedPlanThesis", False)),
            on_portfolio_digest=bool(it.get("onPortfolioDigest", False)),
    ...
    def save_preferences(self, user_id: str, prefs: AlertPreferences) -> AlertPreferences:
        item = {
            ...
            "onPortfolioDigest": prefs.on_portfolio_digest,
